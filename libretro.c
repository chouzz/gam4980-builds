...
static uint8_t _joyk[16] = {
    ...
    [RETRO_DEVICE_ID_JOYPAD_Y] = KEY_INSERT,
    [RETRO_DEVICE_ID_JOYPAD_SELECT] = KEY_SEARCH,
    [RETRO_DEVICE_ID_JOYPAD_START] = KEY_MODIFY,
    ...
    [RETRO_DEVICE_ID_JOYPAD_L2] = KEY_DEL,
    [RETRO_DEVICE_ID_JOYPAD_R2] = KEY_HELP,
